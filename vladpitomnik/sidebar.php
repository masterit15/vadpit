...
<div id="sidebar">
  ...
  <div id="filter" data-url="<?php echo site_url ()?>/wp-admin/admin-ajax.php">
    <div class="filter_group">
      ...
      <input id="filter_name" type="text" value="<?=$_GET['name']?>" class="filter_input">
    </div>
    <div class="filter_group">
    ...
    <div class="filter_group">
      ...
      <div class="filter_action">
        <button data-param="petsType" data-value="dog" class="filter_btn"><i class="fas fa-dog"></i></button>
